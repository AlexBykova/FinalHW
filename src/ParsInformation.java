...
public class ParsInformation {

    public HashMap<String, Object> parsInputData() {
        InputInformation inputData = new InputInformation();
        ...
        for (String i : data) {
            ...
            } else if (i.matches("\\d{4}\\.\\d{1,2}\\.\\d{1,2}")) {
                String[] arrayDate = i.split("\\.");
                boolean flag = true;
                if (Integer.parseInt(arrayDate[2]) < 0 ||
                    ...
                    if (Integer.parseInt(arrayDate[0]) % 4 == 0) {
